...
public class Botonera {
	...
	public void dibujar(Personaje personaje,Entorno e,boolean selec,boolean selec2) {
		...
		if (selec == true) {
			e.cambiarFont("Felix Titling", 10, Color.GRAY,1);
			e.escribirTexto("BOMBA DE FUEGO", 654, 205);
		}else {
			e.cambiarFont("Felix Titling", 11, Color.WHITE,1);
			e.escribirTexto("BOMBA DE FUEGO", 654, 205);
		}
		
		// Poder 2:
		if (selec2 == true) {
			e.cambiarFont("Felix Titling", 12, Color.GRAY,1);
			e.escribirTexto("RAYO", 680, 305);
		}else {
			e.cambiarFont("Felix Titling", 14, Color.WHITE,1);
			e.escribirTexto("RAYO", 680, 305);
		}
		...
		e.cambiarFont("Felix Titling", 14, Color.WHITE,1);
		e.escribirTexto("PUNTUACIÓN:" , 650, 520);
		e.cambiarFont("Felix Titling",30,Color.YELLOW,1);
		e.escribirTexto("" + personaje.kills , 700, 550);
	}
}
